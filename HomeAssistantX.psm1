...
$PowerForgeDevelopmentBinaryRoot = [IO.Path]::GetFullPath([IO.Path]::Combine($PSScriptRoot, 'HomeAssistantX.PowerShell', 'bin'))
$PowerForgeDevelopmentBinaryMode = 'Auto'
$PowerForgeDevelopmentBinaryEnvironmentVariable = 'HOMEASSISTANTX_USE_DEVELOPMENT_BINARIES'
$PowerForgeDevelopmentConfigurationEnvironmentVariable = 'HOMEASSISTANTX_DEVELOPMENT_CONFIGURATION'
$PowerForgeDevelopmentCoreFrameworks = @('netstandard2.0', 'net10.0', 'net472')
$PowerForgeDevelopmentDesktopFrameworks = @('net472', 'netstandard2.0', 'net10.0')
...
if ($PowerForgeDevelopmentEnabled) {
    ...
    foreach ($PowerForgeDevelopmentConfiguration in $PowerForgeDevelopmentConfigurations) {
        foreach ($PowerForgeDevelopmentFramework in $PowerForgeDevelopmentFrameworks) {
            $PowerForgeDevelopmentCandidate = [IO.Path]::Combine($PowerForgeDevelopmentBinaryRoot, $PowerForgeDevelopmentConfiguration, $PowerForgeDevelopmentFramework, 'HomeAssistantX.PowerShell.dll')
    ...
    if ($PowerForgeDevelopmentBinaryPath) {
        try {
            ...
            if ($PSEdition -eq 'Core' -and $PowerForgeDevelopmentUseAssemblyLoadContext) {
                if (-not ('HomeAssistantX.DevelopmentModuleLoadContext.ModuleAssemblyLoadContext' -as [type])) {
...
namespace HomeAssistantX.DevelopmentModuleLoadContext
{
...
'@ -Language CSharp -ErrorAction Stop
                ...
                $PowerForgeDevelopmentModuleAssembly = [HomeAssistantX.DevelopmentModuleLoadContext.ModuleAssemblyLoadContext]::LoadModule($PowerForgeDevelopmentBinaryPath, 'HomeAssistantX.Development')
                ...
                $RegisterPowerForgeAssemblyTypeAccelerators = {
                    ...
                    $Mode = 'AllowList'
                    $RequestedTypes = @('HomeAssistantX.PowerShell.HomeAssistantConnection', 'HomeAssistantX.PowerShell.HomeAssistantLogLine', 'HomeAssistantX.PowerShell.HomeAssistantAppAction', 'HomeAssistantX.Inventory.HomeAssistantEntityInfo', 'HomeAssistantX.Services.HomeAssistantActionDefinition', 'HomeAssistantX.Controls.HomeAssistantPowerAction', 'HomeAssistantX.Controls.HomeAssistantCoverAction', 'HomeAssistantX.Controls.HomeAssistantMediaPlaybackAction', 'HomeAssistantX.Controls.HomeAssistantMediaVolumeStepAction', 'HomeAssistantX.Controls.HomeAssistantMediaRepeatMode', 'HomeAssistantX.Controls.HomeAssistantMediaEnqueueMode', 'HomeAssistantX.Controls.HomeAssistantRemoteCommandType', 'HomeAssistantX.PowerShell.HomeAssistantRemoteAction', 'HomeAssistantX.Controls.HomeAssistantLockAction', 'HomeAssistantX.Controls.HomeAssistantAlarmAction', 'HomeAssistantX.Controls.HomeAssistantButtonDomain', 'HomeAssistantX.Controls.HomeAssistantFanAction', 'HomeAssistantX.Controls.HomeAssistantFanDirection', 'HomeAssistantX.Controls.HomeAssistantHelperDomain', 'HomeAssistantX.Controls.HomeAssistantHumidifierAction', 'HomeAssistantX.Controls.HomeAssistantLawnMowerAction', 'HomeAssistantX.Controls.HomeAssistantSirenAction', 'HomeAssistantX.Controls.HomeAssistantVacuumAction', 'HomeAssistantX.Controls.HomeAssistantValveAction', 'HomeAssistantX.Controls.HomeAssistantWaterHeaterAction', 'HomeAssistantX.PowerShell.HomeAssistantRoutineAction', 'HomeAssistantX.Authentication.IHomeAssistantAccessTokenProvider', 'HomeAssistantX.Authentication.StaticAccessTokenProvider', 'HomeAssistantX.Operations.HomeAssistantCapabilityAvailability', 'HomeAssistantX.Energy.HomeAssistantEnergyPeriod', 'HomeAssistantX.Recorder.HomeAssistantStatisticKind', 'HomeAssistantX.Recorder.HomeAssistantStatisticPeriod', 'HomeAssistantX.Recorder.HomeAssistantStatisticType', 'HomeAssistantX.Recorder.HomeAssistantStatisticMeanType', 'HomeAssistantX.Recorder.HomeAssistantStatisticImportMetadata', 'HomeAssistantX.Recorder.HomeAssistantStatisticImportRow', 'HomeAssistantX.Weather.HomeAssistantWeatherForecastType', 'HomeAssistantX.Weather.HomeAssistantWeatherFeature', 'HomeAssistantX.Cameras.HomeAssistantCameraFeature', 'HomeAssistantX.Cameras.HomeAssistantCameraOrientation', 'HomeAssistantX.Dashboards.HomeAssistantDashboardResourceType')
                    $RequestedAssemblies = @()
                        ...
                        if ($null -ne $AddExportedAlias) {
                            foreach ($Alias in $PowerForgeDevelopmentInnerModule.ExportedAliases.Values) {
                                ...
                                try {
                                    ...
                                    Write-Warning -Message "Alias '$($Alias.Name)' from HomeAssistantX.PowerShell could not be re-exported: $($_.Exception.Message)"
                                }
                            }
                        } else {
                            Write-Warning -Message "AddExportedAlias is not available on this PowerShell version. Aliases from HomeAssistantX.PowerShell will not be re-exported to the module scope."
                        }
                    } else {
                        Write-Warning -Message "AddExportedCmdlet is not available on this PowerShell version. Falling back to direct Import-Module; cmdlets from HomeAssistantX.PowerShell will load from the default context."
                        & $ImportModule $PowerForgeDevelopmentBinaryPath -ErrorAction Stop
                    }
                }

            } else {
                $PowerForgeDevelopmentLoadedType = 'HomeAssistantX.PowerShell.Initialize' -as [type]
