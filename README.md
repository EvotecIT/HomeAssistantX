...
dotnet test tests/HomeAssistantX.Tests/HomeAssistantX.Tests.csproj --configuration Release --no-build
dotnet pack src/HomeAssistantX/HomeAssistantX.csproj --configuration Release --no-build
```
